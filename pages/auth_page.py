...
class AuthPage:
    ...
    def signup(self, name, email, document):
        ...
        try:
            ...
            WordGenerator.add_screenshot_with_description(self, document, "Sign Up Data", "signup.png")
    ...
    def app_form(self, password, title, birth_date, birth_month, birth_year, newsletter, offers, firstname, lastname, company, address, country, state, zipcode, mobile, email, document):
        ...
        try:
            ...
            WordGenerator.add_screenshot_with_description(self, document, "Form Data", "form_app.png")
            ...
            logging.info("Clicking Create Account")
            WordGenerator.add_screenshot_with_description(self, document, "Account Created", "account_created.png")
            ...
            WordGenerator.add_screenshot_with_description(self, document,f"{e}", "account_creation_error.png")
            raise e
    ...
    def delete_account(self, document):
        ...
        try:
            ...
            WordGenerator.add_screenshot_with_description(self, document, "Account Deleted", "account_deleted.png")
        except Exception as e:
